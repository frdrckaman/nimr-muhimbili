...
if env("DJANGO_DEBUG"):
    ...
    NIMR_MANAGER_PHOTO_DIR = env.str("NIMR_CDN_MANAGER_PHOTO_DIR_DEBUG")
    NIMR_CDN_SLIDER_PHOTO_DIR = env.str("NIMR_CDN_SLIDER_PHOTO_DIR_DEBUG")
else:
    ...
    NIMR_MANAGER_PHOTO = env.str("NIMR_CDN_MANAGER_PHOTO_DIR_LIVE")
    NIMR_CDN_SLIDER_PHOTO_DIR = env.str("NIMR_CDN_SLIDER_PHOTO_DIR_LIVE")
